...
def get_heat_map():
   ...
   return  np.array([
           ...
           [2879, 2, 0, 0, 0, 0, 0, 0, 0, 0, ],
           [3291, 2, 2, 0, 0, 0, 0, 0, 0, 0, ],
           [3691, 2, 2, 2, 0, 0, 0, 0, 0, 0, ],
           [4097, 2, 2, 2, 2, 0, 0, 0, 0, 0, ],
           [4507, 2, 2, 2, 2, 2, 0, 0, 0, 0, ],
           [4925, 2, 2, 2, 2, 2, 2, 0, 0, 0, ],
           [5343, 2, 2, 2, 2, 2, 2, 2, 0, 0, ],
           [5755, 2, 2, 2, 2, 2, 2, 2, 2, 0, ],
           [6578, 2, 2, 2, 2, 2, 2, 2, 2, 2, ]
   ]).astype(float)
